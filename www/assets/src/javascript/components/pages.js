...
(function($) {
    ...
    var Notification = function(container, options) {
        ...
        self.options = $.extend(true, {}, $.fn.djcNotification.defaults, options);
    ...
    $.fn.djcNotification = function(options) {
        return new Notification(this, options);
    };

    $.fn.djcNotification.defaults = {
        style: 'simple',
        message: null,
        position: 'top-right',
        type: 'info',
...
(function($) {
    ...
    Portlet.prototype.collapse = function() {
        ...
        if (this.$element.hasClass('panel-collapsed')) {
            ...
            icon.removeClass().addClass('fa fa-angle-up');
